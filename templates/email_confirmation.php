...
<body style="margin: 0;padding: 0;min-width: 100%;background-color: #fbfbfb">
    <style type="text/css">
        ...
        .feature blockquote ol,
        .feature blockquote ul {
            line-height: 50px
        }
        @media only screen and (max-width: 620px) {
            p,
        ...
        .wrapper .feature p a,
        .wrapper .feature ol a,
        .wrapper .feature ul a {
            border-bottom: 1px solid #41637e
        }
        .wrapper .feature p a:hover,
        .wrapper .feature ol a:hover,
        .wrapper .feature ul a:hover {
            color: #30495c !important;
            border-bottom: 1px solid #30495c !important
        }
        .btn a {}.wrapper .btn a {}.wrapper .btn a {
            font-family: Georgia, serif
        }
        .wrapper .btn a {
        ...
        .wrapper .footer .social a {}.wrapper .footer .social .social-text,
        .wrapper .footer .social a {
            font-family: Georgia, serif
        }
        .footer .social .social-text,
        .footer .social a {}.footer .social .social-text,
        .footer .social a {
                      ...
                      <tbody><tr>
                        ...
                        <table class="header" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;width: 602px">
                            <tbody>
                                ...
                                <tr>
                                    <td class="logo" style="padding: 32px 0;vertical-align: top;font-size: 26px;font-weight: 700;letter-spacing: -0.02em;line-height: 32px;text-align: center;color: #41637e;font-family: Cabin,Avenir,sans-serif !important" align="center">
                                        <center>
                                            <div id="emb-email-header"><a style="text-decoration: none;transition: all .2s;color: #41637e" href="http://labs.lucianoandrade.me/hotel">Royal Park Hotel</a>
                                            </div>
                                        </center>
                                    </td>
                                </tr>
                        ...
                        <table style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto">
                            <tbody>
                                <tr>
                                    <td class="border" style="padding: 0;vertical-align: top;font-size: 1px;line-height: 1px;background-color: #e9e9e9;width: 1px">&#8203;</td>
                                    <td style="padding: 0;vertical-align: top">
                                        <table class="one-col feature" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;width: 600px;background-color: #ffffff;font-size: 14px">
                                            <tbody>
                                                <tr>
                                                    <td class="column" style="padding: 0;vertical-align: top;text-align: center">
                                                        <div>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px">
                                                                        ...
                                                                        <p style="Margin-top: 0;color: #565656;line-height: 32px;font-family: Georgia,serif;font-size: 21px;Margin-bottom: 32px;text-align: center">Ol&#225;, {$usuario}.</p>
                                                                        <p style="Margin-top: 0;color: #565656;line-height: 32px;font-family: Georgia,serif;font-size: 21px;Margin-bottom: 32px;text-align: center">Este email lhe foi enviado por ter sido usado para criar uma conta no nosso site. Caso realmente tenha sido criado por voc&ecirc;, clique no bot&#227;o abaixo. Ap&#243;s isso poder&#225; usar livremente nosso site. Obrigado.</p>
                                                                ...
                                                                <tr>
                                                                    <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px">
                                                                        ...
                                                                        <div class="btn" style="Margin-bottom: 32px;padding: 2px;text-align: center">
                                                                            <![if !mso]><a style="mso-hide: all;border: 1px solid #ffffff;display: inline-block;font-size: 13px;font-weight: bold;line-height: 15px;outline-style: solid;outline-width: 2px;padding: 10px 30px;text-align: center;text-decoration: none !important;transition: all .2s;color: #fff !important;font-family: Georgia,serif;background-color: #41637e;outline-color: #41637e;text-shadow: 0 1px 0 rgba(0,0,0,0.3)" href="{$link_hash}">Confirmar</a>
                                                                            <![endif]>
                                                                            <!--[if mso]><v:rect xmlns:v="urn:schemas-microsoft-com:vml" href="{$link_hash}" style="width:132px" fillcolor="#41637E" strokecolor="#41637E" strokeweight="6px"><v:stroke linestyle="thinthin"></v:stroke><v:textbox style="mso-fit-shape-to-text:t" inset="0px,7px,0px,7px"><center style="font-size:13px;line-height:15px;color:#FFFFFF;font-family:Georgia,serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:0px">Confirmar</center></v:textbox></v:rect><![endif]-->
                                                                        </div>
                                                                ...
                                                                <tr>
                                                                    <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px">
                                                                        ...
                                                                        <table class="divider" style="border-collapse: collapse;border-spacing: 0;width: 100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="inner" style="padding: 0;vertical-align: top;padding-bottom: 32px" align="center">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px">
                                                                        ...
                                                                        <p style="Margin-top: 0;color: #565656;line-height: 32px;font-family: Georgia,serif;font-size: 11px;Margin-bottom: 32px;text-align: center">Caso n&#227;o tenha feito o cadastro no nosso site, favor desconsiderar este email.</p>
                                                                ...
                                                                <tr>
                                                                    <td class="padded" style="padding: 0;vertical-align: top;padding-left: 10px;padding-right: 0;font-size: 12px;line-height: 20px;color: #999;font-family: Georgia,serif;text-align: right">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <!--<span class="block"><unsubscribe style="font-weight:bold;text-decoration:none;">Unsubscribe</unsubscribe></span>-->
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
